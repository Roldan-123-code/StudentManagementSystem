...
$facultyId=$_POST['facultyId'];
  $dateCreated = date("Y-m-d");
    ...
    $query=mysqli_query($con,"insert into tblstudent(firstName,lastName,otherName,matricNo,levelId,facultyId,departmentId,sessionId,dateCreated) value('$firstname','$lastname','$othername','$matricNo','$levelId','$facultyId','$departmentId','$sessionId','$dateCreated')");
                                    ...
                                    <div class="card-body">
                                       <div class="<?php echo $alertStyle;?>" role="alert"><?php echo $statusMsg;?></div>
                                        ...
                                        <div class="row">
                                                <div class="col-6">
                                                    <div class="form-group">
                                                        <label for="cc-exp" class="control-label mb-1">Student ID No</label>
                                         ...
                                         <div class="row">
                                             ...
                                             <p><small><i>Note: By default student's password is set to "<b>student@ccbd</b>"</i></small></p>
